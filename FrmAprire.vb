...
#Region " CARICA TABELLA "
    ...
    Public Sub CaricaDGV(dgv As DataGridView, tableName As String)
        ...
        If dt Is Nothing Then
            IPMessageBox.Show($"Nessun dato per la tabella '{tableName}'.")
            Return
        End If
        ...
        Catch ex As Exception
            ...
            IPMessageBox.Show("Attenzione: " & ex.Message)
        End Try
    End Sub
    ...
    Private Sub CaricaTabella(nomeTabella As String)
        ...
        Catch ex As SqlException
            IPMessageBox.Show("SQL ERROR: " & ex.Number & vbCrLf & ex.Message)
    ...
    Private Sub RjCircSalvaTabella_Click(sender As Object, e As EventArgs) Handles RjCircSalvaTabella.Click
        ...
        Try
            ...
            If String.IsNullOrEmpty(tableName) Then
                IPMessageBox.Show("Nome tabella non impostato. Usa CaricaDGV(dgv, ""TableName"").")
                Return
            End If
